...
for x in [0]:
    ...
    #### PLOT ALBEDO ######
    plt.plot(wvl, albedo), plt.ylabel('ALBEDO'), plt.xlabel('WAVELENGTH (microns)'), plt.xlim(0.3,1.8),plt.ylim(0,1)
    print('BROADBAND ALBEDO = ', BBA), plt.axvline(x = 0.68,color='g',linestyle='dashed')

plt.show()

    # if albedo[36] < albedo[40]:
    #     print("RED EDGE DETECTED")
    #     print("2DBA ratio = ",albedo[40]/albedo[36])